...
- **Explorer Temporal panel never rendered after clicking the toolbar button** (#830) by @Sameer6305
  ...
  - Both component fixes applied identically to `GraphWorkspaceShell.tsx`
